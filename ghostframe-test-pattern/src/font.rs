...
pub fn glyph(c: char) -> &'static [u8; 8] {
    match c {
        ' ' => &[0, 0, 0, 0, 0, 0, 0, 0],
        '/' => &[
            0b000001, 0b000010, 0b000010, 0b000100, 0b000100, 0b001000, 0b010000, 0b000000,
        ],
        'A' => &[
        ...
        'G' => &[
            0b011110, 0b100001, 0b100000, 0b100111, 0b100001, 0b100001, 0b011110, 0b000000,
        ],
        'H' => &[
            0b100001, 0b100001, 0b100001, 0b111111, 0b100001, 0b100001, 0b100001, 0b000000,
        ],
        'I' => &[
            0b011110, 0b001100, 0b001100, 0b001100, 0b001100, 0b001100, 0b011110, 0b000000,
        ],
        'L' => &[
        ...
        'R' => &[
            0b111110, 0b100001, 0b100001, 0b111110, 0b100100, 0b100010, 0b100001, 0b000000,
        ],
        'S' => &[
            0b011111, 0b100000, 0b100000, 0b011110, 0b000001, 0b000001, 0b111110, 0b000000,
        ],
        'T' => &[
            0b111111, 0b001100, 0b001100, 0b001100, 0b001100, 0b001100, 0b001100, 0b000000,
        ],
        ...
        _ => &[
            0b111111, 0b111111, 0b111111, 0b111111, 0b111111, 0b111111, 0b111111, 0b000000,
        ],
    }
}
